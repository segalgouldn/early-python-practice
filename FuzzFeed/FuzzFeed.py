...
class Fuzzfeed(object):
	...
	def __init__(self, post, iterations):
		...
		self.reasonsPart1 = ['That Will Make You Hate', 
		...
		self.twitter = Twython(self.appKey, self.appSecret, self.tokenKey, self.tokenSecret)
		...
		for i in range(self.iterations):
			...
			self.title = self.number + ' ' + self.adjective + ' ' + self.noun + ' ' + self.reasonPart1 + ' ' + self.reasonPart2
